...
var _reactGauge = require('react-gauge');

var _reactGauge2 = _interopRequireDefault(_reactGauge);
...
var ReactGaugeTool = (function (_React$Component) {
  _inherits(ReactGaugeTool, _React$Component);

  function ReactGaugeTool(props) {
    _classCallCheck(this, ReactGaugeTool);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ReactGaugeTool).call(this, props));
  ...
  _createClass(ReactGaugeTool, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'gauge-tool' },
        _react2.default.createElement(_reactGauge2.default, { value: this.state.value }),
        _react2.default.createElement(
          'div',
          { className: 'input' },
          _react2.default.createElement('input', { type: 'number', onChange: this.updateValue.bind(this), value: this.state.value })
        )
      );
    }
  }]);

  return ReactGaugeTool;
})(_react2.default.Component);

ReactGaugeTool.defaultProps = { min: 0, max: 100, value: 0 };

_reactDom2.default.render(_react2.default.createElement(ReactGaugeTool, null), document.getElementById('gauge-tool'));

},{"react":159,"react-dom":2,"react-gauge":3}]},{},[160])


//# sourceMappingURL=react-gauge.js.map
